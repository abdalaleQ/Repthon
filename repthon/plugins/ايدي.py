...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁  مبرمج الـسـورس 𓄂𓆃 ⌁" if user_id == 6611904446 else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالـك الـحسـاب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 6611904446  else rotbat
    caption = "✛━━━━━━━━━━━━━✛\n"
